...
<head>
	...
	<title>Legacy Investimentos</title>
                                ...
                                <div class="main-menu d-none d-lg-block">
                                    <nav> 
                                        <ul id="navigation">                                                                                          
                                            ...
                                            <li><a href="#nossa-tese">Nossa tese</a></li>
...
<main>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7 col-md-8">
                            <div class="hero__caption">
                                ...
                                <h1 data-animation="fadeInLeft" data-delay=".5s" >Especialistas em crédito corporativo</h1>
                                <p data-animation="fadeInLeft" data-delay=".9s">A simplicidade é o maior nível da sofisticação.</p>
                                <!-- Hero-btn -->
                                <!-- <div class="hero__btn" data-animation="fadeInLeft" data-delay="1.1s">
                                    <a href="industries.html" class="btn hero-btn">Nossos serviços</a>
                                </div> -->
                            </div>
                        </div>
                    </div>
    ...
    <!-- Services Area End -->
    <!--? About Area Start-->
    <div id="quem-somos" class="support-company-area mt-5 pt-100 section-bg fix">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6">
                    <div class="support-location-img">
                        <img src="assets/img/gallery/landscape2.jpeg" alt="">
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6">
                    <div class="right-caption">
                        ...
                        <div class="support-caption">
                            <p class="pera-top text-black">A LEGACY Investimentos é o produto da reunião de ex-executivos do mercado financeiro, especialistas em crédito corporativo e convictos de que a evolução do crédito no Brasil passa, obrigatoriamente, pelo desenvolvimento e democratização do Mercado de Capitais. Nosso propósito é, de forma independente e pragmática, prover o acesso de boas empresas a estruturas de captação mais sofisticadas e fora do ambiente, exclusivamente, bilateral bancário.</p>
    ...
    <!-- About Area End-->
    <div id="nossa-tese" class="support-company-area pt-100 pb-100 mt-5 section-bg fix">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6">
                    <div class="left-caption text-black">
                        <!-- Section Tittle -->
                        <div class="section-tittle section-tittle2 mb-50">
                            <span></span>
                            <h2 class="text-black">Nossa tese</h2>
                        </div>
                        <div class="support-caption">
                            <p class="pera-top text-black">A forte concentração bancária, aliada à queda e à estabilidade das taxas de juros em níveis nominais nunca vistos, tornou-se o ambiente perfeito para o desenvolvimento do Mercado de Capitais no Brasil.

                                Somos obcecados por desintermediação financeira e fundamos a LEGACY Investimentos para assessorar, de forma independente, empresas que procuram novas fontes de financiamento, seja por meio de Operações Estruturadas ou via Fusões e Aquisições.</p>
                            <!-- <p class="mb-65">Mollit anim laborum.Dvcuis aute serunt  iruxvfg dhjkolohr indd re voluptate velit esscillumlore eu quife nrulla parihatur. Excghcepteur sfwsignjnt occa cupidatat non aute iruxvfg dhjinulpadeserunt moll.</p> -->
                            <!-- <a href="about.html" class="btn post-btn">More About Us</a> -->
                        </div>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="support-location-img">
                        <img src="assets/img/gallery/landscape.jpeg" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-xl-10 col-lg-10 col-md-9">
                    <div class="h1-testimonial-active">
                        <!-- Single Testimonial --e>
                        <div class="single-testimonial text-center">
                            <!-- Testimonial Content --e>
    ...
    <!-- Coun Down End -->
    <!-- Team Start -->
    <div id="nosso-time" class="team-area py-5">
        <div class="container">
            <div class="row">
                <div class="cl-xl-7 col-lg-8 col-md-10">
                    <!-- Section Tittle -->
            ...
            <div class="row">
                <!-- single Tem -->
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="assets/img/gallery/marcos.jpg" alt="">
                        </div>
                        <div class="team-caption">
                            <h3><a href="#">Marcos Travassos</a></h3>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="assets/img/gallery/cleiton.jpg" alt="">
                        </div>
                        <div class="team-caption">
                            <h3><a href="#">Cleiton Duarte</a></h3>
                            <span>Sócio</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="assets/img/gallery/thomaz.jpg" alt="Thomaz Staziak">
                        </div>
                        <div class="team-caption">
                            <h3><a href="#">Thomaz Staziak</a></h3>
                            <span>Sócio</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="assets/img/gallery/walter.jpg" alt="">
                        </div>
                        <div class="team-caption">
                            <h3><a href="#">Walter Bereska</a></h3>
                            <span>Sócio</span>
                        </div>
                    </div>
                </div>
...
<footer>
    <!--? Footer Start-->
    <div class="footer-area" style="border-top: 1px solid #ccc; background: none;">
        <div class="container">
